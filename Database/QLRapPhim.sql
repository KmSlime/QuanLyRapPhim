...
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND]) VALUES (N'NV00', N'admin', CAST(N'2021-10-22' AS Date), N'admin', NULL, 123456789)
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND]) VALUES (N'NV01', N'Bán Vé', CAST(N'2021-10-24' AS Date), NULL, NULL, 14725836)
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND]) VALUES (N'NV02', N'Bán Bắp', CAST(N'2021-10-25' AS Date), NULL, NULL, 1233333)
INSERT [dbo].[NhanVien] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND]) VALUES (N'NV03', N'Bán Thức Uống', CAST(N'2021-10-25' AS Date), NULL, NULL, 14725844)

INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'NguyenHongLiem', N'59113821474147731767615617822114745333', 1, N'NV00')-- mk hiện thị là admin
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'VuThiHien', N'59113821474147731767615617822114745333', 1, N'NV00')-- mk hiện thị là admin
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'TranHuynhNhu', N'59113821474147731767615617822114745333', 1, N'NV00')-- mk hiện thị là admin
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'NV01', N'5512317111114510840231031535810616566202691', 2, N'NV01')-- mk hiện thị là 1
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'NV02', N'5512317111114510840231031535810616566202691', 2, N'NV02')-- mk hiện thị là 1
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNV]) VALUES (N'NV03', N'5512317111114510840231031535810616566202691', 2, N'NV02')-- mk hiện thị là 1


INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [DiemTichLuy]) VALUES (N'KH01', N'Nguyễn Văn A', CAST(N'1999-05-03' AS Date), N'Bla Bla', N'0123456789', 218161554, 0)
INSERT [dbo].[KhachHang] ([id], [HoTen], [NgaySinh], [DiaChi], [SDT], [CMND], [DiemTichLuy]) VALUES (N'KH02', N'Nguyễn Văn B', CAST(N'2000-05-03' AS Date), N'Bla Bla', N'0123456789', 218161564, 0)
...
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P01', N'Avengers: Cuộc Chiến Vô Cực', N'Avengers: Infinity War', 150, CAST(N'2021-10-24' AS Date), CAST(N'2021-10-26' AS Date), N'Mỹ', N'Anthony Russo,  Joe Russo', 2018)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P02', N'Lật Mặt: 3 Chàng Khuyết', N'Lat Mat 3 Chang Khuyet', 100, CAST(N'2021-10-24' AS Date), CAST(N'2021-10-26' AS Date), N'Việt Nam', N'Lý Hải', 2018)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P03', N'100 Ngày Bên Em', NULL, 100, CAST(N'2021-10-24' AS Date), CAST(N'2021-10-26' AS Date), N'Việt Nam', N'Vũ Ngọc Phượng', 2018)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P04', N'Ngỗng Vịt Phiêu Lưu Ký', N'Duck Duck Goose', 91, CAST(N'2021-10-24' AS Date), CAST(N'2021-10-26' AS Date), N'Mỹ', N'Christopher Jenkins', 2018)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P05', N'Nguyễn Hồng Liêm', N'Dream', 91, CAST(N'2021-10-24' AS Date), CAST(N'2021-10-30' AS Date), N'Đông Lào', N'Dream - Nhóm trưởng', 1999)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P06', N'Vũ Thị Hiền', N'Thành viên', 91, CAST(N'2021-10-24' AS Date), CAST(N'2021-10-30' AS Date), N'Đông Lào', N'Dream - Thư ký', 2000)
INSERT [dbo].[Phim] ([id], [TenPhim], [MoTa], [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX]) VALUES (N'P07', N'Trần Huỳnh Như', N'Thành viên', 91, CAST(N'2021-10-24' AS Date), CAST(N'2021-10-30' AS Date), N'Đông Lào', N'Dream - Thư ký', 2000)
...
INSERT [dbo].[DinhDangPhim] ([id], [idPhim], [idLoaiManHinh]) VALUES (N'DD05', N'P05', N'MH01')
INSERT [dbo].[DinhDangPhim] ([id], [idPhim], [idLoaiManHinh]) VALUES (N'DD06', N'P06', N'MH03')
INSERT [dbo].[DinhDangPhim] ([id], [idPhim], [idLoaiManHinh]) VALUES (N'DD07', N'P07', N'MH03')



INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC01', CAST(N'2021-10-25T08:50:00.000' AS DateTime), N'PC01', N'DD01', 85000.0000, 1)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC02', CAST(N'2021-10-25T08:05:00.000' AS DateTime), N'PC02', N'DD01', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC03', CAST(N'2021-10-25T08:10:00.000' AS DateTime), N'PC03', N'DD02', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC04', CAST(N'2021-10-25T09:20:00.000' AS DateTime), N'PC04', N'DD03', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC05', CAST(N'2021-10-25T22:25:00.000' AS DateTime), N'PC02', N'DD05', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC06', CAST(N'2021-10-25T11:20:00.000' AS DateTime), N'PC03', N'DD06', 85000.0000, 0)
INSERT [dbo].[LichChieu] ([id], [ThoiGianChieu], [idPhong], [idDinhDang], [GiaVe], [TrangThai]) VALUES (N'LC07', CAST(N'2021-10-25T15:20:00.000' AS DateTime), N'PC04', N'DD07', 85000.0000, 0)
